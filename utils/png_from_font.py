...
def create_png(font_file_name, png_file_name):
        ...
        with open(png_file_name, 'wb') as png_file:
                ...
                image_data = [[0 for _ in range((16 + 2) * font.WIDTH)]
...
def main():
        ...
        for file_name in os.listdir(args.font_directory):
                if file_name.endswith('.py'):
                        font_file_name = f'{args.font_directory}/{file_name}'
                        png_file_name = f'{args.png_directory}/{os.path.splitext(file_name)[0]}.png'
